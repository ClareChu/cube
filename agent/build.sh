...
docker build -t hidevops/agent-java-jar:v1.0.8 .

rm -rf Dockerfile

docker push hidevops/agent-java-jar:v1.0.8

## docker build go

cp docker/go/Dockerfile  Dockerfile

docker build -t hidevops/agent-go:v1.0.8 .

rm -rf Dockerfile

docker push hidevops/agent-go:v1.0.8
