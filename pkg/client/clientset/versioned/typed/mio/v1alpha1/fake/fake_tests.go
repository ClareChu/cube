...
var testsesResource = schema.GroupVersionResource{Group: "cube.io", Version: "v1alpha1", Resource: "testses"}

var testsesKind = schema.GroupVersionKind{Group: "cube.io", Version: "v1alpha1", Kind: "Tests"}
