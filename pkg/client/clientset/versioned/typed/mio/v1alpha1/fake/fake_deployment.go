...
var deploymentsResource = schema.GroupVersionResource{Group: "cube.io", Version: "v1alpha1", Resource: "deployments"}

var deploymentsKind = schema.GroupVersionKind{Group: "cube.io", Version: "v1alpha1", Kind: "Deployment"}
