...
var buildconfigsResource = schema.GroupVersionResource{Group: "cube.io", Version: "v1alpha1", Resource: "buildconfigs"}

var buildconfigsKind = schema.GroupVersionKind{Group: "cube.io", Version: "v1alpha1", Kind: "BuildConfig"}
