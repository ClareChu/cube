...
var pipelinesResource = schema.GroupVersionResource{Group: "cube.io", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "cube.io", Version: "v1alpha1", Kind: "Pipeline"}
