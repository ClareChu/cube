...
var appsResource = schema.GroupVersionResource{Group: "cube.io", Version: "v1alpha1", Resource: "apps"}

var appsKind = schema.GroupVersionKind{Group: "cube.io", Version: "v1alpha1", Kind: "App"}
