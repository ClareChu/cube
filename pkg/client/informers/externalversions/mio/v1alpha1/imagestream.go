	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MioV1alpha1().ImageStreams(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MioV1alpha1().ImageStreams(namespace).Watch(options)
			},
		},
		&miov1alpha1.ImageStream{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageStreamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&miov1alpha1.ImageStream{}, f.defaultInformer)
}
