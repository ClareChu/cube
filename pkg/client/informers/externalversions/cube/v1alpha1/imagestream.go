...
type ImageStreamInformer interface {
	...
	Lister() v1alpha1.ImageStreamLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CubeV1alpha1().ImageStreams(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CubeV1alpha1().ImageStreams(namespace).Watch(options)
			},
		},
		&cube_v1alpha1.ImageStream{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageStreamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cube_v1alpha1.ImageStream{}, f.defaultInformer)
}

func (f *imageStreamInformer) Lister() v1alpha1.ImageStreamLister {
	return v1alpha1.NewImageStreamLister(f.Informer().GetIndexer())
}
